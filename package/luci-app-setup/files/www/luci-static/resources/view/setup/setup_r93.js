...
return view.extend({
	...
	render: function(data) {
		...
		self.refs.hotspotQuickMaintStart = E('input', { 'class': 'cbi-input-text', 'type': 'time', 'value': self.state.hotspotQuickMaintStart || '02:00', 'style': 'max-width:120px;' });
		self.refs.hotspotQuickMaintEnd = E('input', { 'class': 'cbi-input-text', 'type': 'time', 'value': self.state.hotspotQuickMaintEnd || '03:00', 'style': 'max-width:120px;' });
		...
		[
			...
			'hotspotQuickMaintEnabled', 'hotspotQuickMaintStart', 'hotspotQuickMaintEnd',
