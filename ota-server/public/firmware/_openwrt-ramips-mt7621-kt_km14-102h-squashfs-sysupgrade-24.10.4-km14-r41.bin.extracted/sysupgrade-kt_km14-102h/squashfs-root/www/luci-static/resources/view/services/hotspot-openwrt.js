...
var FIELD_GROUPS = {
	...
	portal: [
		...
		{ option: 'mikrotik_compat', label: 'وضع التوافق مع ميكروتيك', hint: 'تفعيل معالجة صفحات ميكروتيك الأصلية (login.html, alogin.html, logout.html) والوسوم البرمجية الخاصة بها.', type: 'checkbox' },
	...
	advanced: [
		{ option: 'mtu', label: 'MTU الهوتسبوت', hint: 'حجم الحزمة الافتراضي. ينصح باستخدام 1400 لتجنب تقطيع البيانات.', placeholder: '1400' },
		{ option: 'txqueuelen', label: 'طابور الإرسال (TX Queue)', hint: 'طول طابور الإرسال لواجهة الهوتسبوت. ينصح بـ 1000 للأداء العالي.', placeholder: '1000' },
		{ option: 'sndbuf', label: 'حجم مخزن الإرسال (sndbuf)', hint: 'حجم المخزن الخاص ببيانات الإرسال في CoovaChilli. 0 للافتراضي.', placeholder: '0' },
		{ option: 'rcvbuf', label: 'حجم مخزن الاستقبال (rcvbuf)', hint: 'حجم المخزن الخاص ببيانات الاستقبال في CoovaChilli. 0 للافتراضي.', placeholder: '0' },
	...
	active: [
		{ option: 'keepalive_timeout', label: 'مدة طرد المنفصلين من Active / Hosts', hint: 'إذا اختفى الجهاز من شبكة الهوتسبوت، يتم إخراجه من Active أو حذفه من Hosts بعد هذه المدة. القيم المقترحة 00:03:00 إلى 00:05:00 لمنع التقطيع للهواتف.', placeholder: '00:05:00' }
	]
};
...
function renderPanel(key, status) {
	...
	if (key == 'radius')
		return E('div', renderFields(key).concat([ renderRadiusTests() ]));
