...
export const env = {
  ...
  OTA_HMAC_SECRET: process.env.OTA_HMAC_SECRET ?? '',
  OTA_HMAC_MAX_SKEW_SECONDS: getNumber('OTA_HMAC_MAX_SKEW_SECONDS', 300),
  OTA_RATE_LIMIT_WINDOW_SECONDS: getNumber('OTA_RATE_LIMIT_WINDOW_SECONDS', 60),
  OTA_RATE_LIMIT_MAX_REQUESTS: getNumber('OTA_RATE_LIMIT_MAX_REQUESTS', 60),
};
