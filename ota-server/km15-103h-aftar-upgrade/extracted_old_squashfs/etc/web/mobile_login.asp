...
<div data-role="page" data-theme="d">
	...
	<div data-role="content" class="ui-grid-a" style="padding: 13 0 5 5px;">
		<table width="100%">
			<tr>
				...
				<td align="right">
					<a href="/login.asp" type="button" data-mini="true" data-ajax="false" onclick="function(){$('#is_mobile').val('1');}">PC 버전</a>
				</td>
			</tr>
		</table>
	</div>
	...
	<div style="padding: 0 0 0 12px;" data-role="fieldcontain"> 
		...
		<table width="100%" style="padding: 10 0 12 0px;">
			...
			<tr>
				<td width="100%">
					<input autocomplete="off" type="text" width="100%" name="UserID" maxlength="64" id="UserID" value"">
				</td>
			</tr>
			<tr>
				<td width="100%">
