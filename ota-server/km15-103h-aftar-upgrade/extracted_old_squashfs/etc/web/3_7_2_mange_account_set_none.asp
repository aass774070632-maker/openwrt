...
<input name="redirect_url" type="hidden" id="redirect_url" value="/set_manage_account.asp" />
							...
							<tr>
										...
										<tr>
											<td class="PD6">
												...
												<input name="Cancel" type="image" src="/images/BTN/BTN_04.gif?Sp2" width="52" height="24" onClick="form_act('/goform/mcr_KTlogOut'); return false;"/>
											</td>
										</tr>
									</table>
								</td>
