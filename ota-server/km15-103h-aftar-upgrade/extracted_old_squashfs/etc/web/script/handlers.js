...
function preLoad() {
	if (!this.support.loading) {
		...
		tempParent.innerHTML = "<a href='http://www.adobe.com/go/getflashplayer' target='_new'><img src='/images/get_flash_player.gif' border=0></a>";
