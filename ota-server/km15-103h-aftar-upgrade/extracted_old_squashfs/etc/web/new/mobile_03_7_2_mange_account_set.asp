...
<input name="redirect_url" type="hidden" id="redirect_url" value="/new/mobile_03_7_2_mange_account_set.asp">
				...
				<td>
					<table align="center" cellspacing="0" cellpadding="0" width="100%" valign="middle">
						...
						<tr>
							<td></td>
							<td>
								<label id="m_passwd_alert" name="m_passwd_alert">비밀번호는 영문과 숫자 조합으로 10자이상 이어야 합니다.</label>
							</td>
						</tr>
					</table>
				</td>
	...
	<div style="padding:10px 0 0 0;">
		<table align="center" cellspacing="0" cellpadding="0" width="100%" valign="middle">
			<tr>
				...
				<td>
					<a href="javascript:;" id="btn_apply1" name="btn_apply1" onclick="return CheckCancel('user_userId', 'user_ChgUserId', 'user_password', 'user_ChgPassword', 'user_ChgPasswordVerify')" data-theme="a" data-role="button" data-mini="false" data-ajax="false">취소</a>
				</td>
			</tr>
		</table>
	</div>
