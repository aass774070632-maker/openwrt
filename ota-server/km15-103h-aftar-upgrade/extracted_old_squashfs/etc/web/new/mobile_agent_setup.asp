...
function form_act(url)
{
	...
	if(e.checked){
		...
		if(mesh_enable == '0' && e.checked == false){
			alert("이미 적용되어 있습니다");
			return false;
		}
		$("#wlanMeshActivity").val("0");
		alert("Mesh 설정이 비활성 되었습니다. 인터넷 연결이 끊어집니다");
	}
...
<input type="hidden" id="wlanRedirectPage" name="wlanRedirectPage" value="/new/mobile_agent_setup.asp">
<div data-role="page" data-theme="d">
	...
	<div data-ajax="false">
		<table align="center" cellspacing="0" cellpadding="0" width="100%" valign="middle">
			<tr>
				<td>
					<img src="/images/explain.png" width="100%" border="0">
				</td>
			</tr>
		</table>
	</div>
	...
	<div style="padding:0 5 12 5px;" data-ajax="false">
		<table align="center" cellspacing="0" cellpadding="0" width="98%" valign="middle">
			...
			<tr id="ssid_pskkey_2" style="display:none">
				<td>
					<label for="text">암호는 10자 이상 64자 이하여야 합니다.(초기값은 기본 설정값임)</label>
				</td>
			</tr>
		</table>
	...
	<div style="padding:0 5 12 5px;" data-ajax="false">
		<table align="center" cellspacing="0" cellpadding="0" width="100%" valign="middle">
			<tr>
				<td>
					<img src="/images/install_guide.png" width="100%" border="0">
				</td>
			</tr>
		</table>
	</div>
