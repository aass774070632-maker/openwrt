...
function pwd_reset(url){
	MobileLoginFail.action = url;
	MobileLoginFail.submit();
	setTimeout(function(){window.history.back()}, 1000);
	return false;
}

function javascript1(){
       	result_url = "http://"+window.location.host+"/login_confirm.asp";
...
<input name="redirect_url" type="hidden" id="redirect_url" value="/new/mobile_login_fail.asp">
	...
	<div style="padding:10px 0 0 0;">
		<table align="center" cellspacing="0" cellpadding="0" width="100%" valign="middle">
			<tr>
				...
				<td width="50%">
					<a href="javascript:;" id="btn_apply1" name="btn_apply1" onclick="javascript1()" data-theme="a" data-role="button" data-mini="false" data-ajax="false">계정재설정</a>
				</td>
			</tr>
		</table>
	</div>
