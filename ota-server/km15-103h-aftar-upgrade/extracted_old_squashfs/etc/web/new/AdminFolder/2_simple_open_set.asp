...
function initForm_WLAN(flag){
	...
	$("#wlanRedirectPage").val("/new/AdminFolder/2_simple_open_set.asp");
	$("#wlanViewWMM").hide();
	...
	if ( document.form_simple.macCloneEnbl[0].checked == true)
	{
		if (document.form_simple.macCloneMac.value != "") {
			...
			if (re.test(document.form_simple.macCloneMac.value)) { 
				document.form_simple.redirect_url.value = "/new/AdminFolder/2_simple_open_set.asp"
				form_act(url);
				document.form_simple.redirect_url.value = "/new/AdminFolder/3_7_8_system_restart_process.asp"
				return false;
			}
			else {
...
<input type=hidden name=SETIPMODE value="/new/AdminFolder/2_simple_open_set.asp" />
<input type="hidden" name="redirect_url" id="redirect_url" value="/new/AdminFolder/3_7_8_system_restart_process.asp" />
<input type="hidden" name="redirect_admWanSet" id="redirect_admWanSet" value="/new/AdminFolder/2_simple_open_set.asp" />
