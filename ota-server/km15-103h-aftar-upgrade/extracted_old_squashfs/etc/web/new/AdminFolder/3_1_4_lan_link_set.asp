...
function ip_range_comment() {
	...
	var relay_ip = "<% mcr_getCfgInterface("DhcpsCfgParam_StartIp_Thrd"); %>";
	var ipsub = new Array();
	var sub0, sub1, sub2;
...
function initValue() {
	...
	var loopback = "<% mcr_getCfgString("LoopbackCfgParam_Enable"); %>";
	...
	initRadioByName("mdi_mdix", mdimdix);
	initRadioByName("loopback_Enbable", loopback);

	passthru_en = "<% mcr_getCfgString("IPv6CfgParam_Passthru"); %>";
	initRadioByName("IPv6_Passthru_Enbable",passthru_en);
...
<input type=hidden name=SETLAN value="/new/AdminFolder/3_1_4_lan_link_set.asp" />
...
<input name="lanNetmask3" type="text" style="width:30;" onmouseover="unlock();" onmouseout="lock();" class="input2" id="lanNetmask3">
							...
							<tr id="MDI_MDIX" style="display:none;">
								<td> 
									<table width="98%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td class="font5"> MDI/MDIX auto 설정</td>
										</tr>
										<tr>
											<td class="PD4"></td>
										</tr>
													...
													<tr>
														<td width="600">
															<table  border="0" cellpadding="0" cellspacing="0" class="font1">
																<tr>
																	<td width="110">
																		<input type="radio" name="mdi_mdix" id="mdi_mdix" value="1">
																		활성
																	</td>
																	<td>
																		<input name="mdi_mdix" type="radio" id="mdi_mdix1" value="0">
																		비활성 
																	</td>
																</tr>
															</table>
										...
										<tr>
											<td class="PD6" >	
												<p align="right"><input type="image" src="/images/BTN/BTN_01.gif?Sp2" alt="" width="52" height="24" value="Apply1" id="btn_apply1" name="btn_apply1" onclick="form_act('/goform/mcr_setLoopDetect'); return false;"/>
											</td>
										</tr>
									</table>
								</td>
							</tr>
							<tr id='tr_IPv6_Passthru'>
								<td> 
									<table width="98%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td class="font5"> IPv6 Passthru 설정</td>
										</tr>
										<tr>
											<td class="PD4"></td>
										</tr>
													...
													<tr>
														<td width="600">
															<table  border="0" cellpadding="0" cellspacing="0" class="font1">
																<tr>
																	<td width="110">
																		<input type="radio" name="IPv6_Passthru_Enbable" id="btn_IPv6_Passsthru_Enable" value="1">
																		활성
																	</td>
																	<td>
																		<input type="radio" name="IPv6_Passthru_Enbable" id="btn_IPv6_Passsthru_Disable" value="0">
																		비활성 
																	</td>
																</tr>
															</table>
										...
										<tr>
											<td class="PD6" >	
												<p align="right"><input type="image" src="/images/BTN/BTN_01.gif?Sp2" alt="" width="52" height="24" value="Apply1" id="btn_apply1" name="btn_apply1" onclick="form_act('/goform/mcr_setIPv6Passthru'); return false;"/>
											</td>
										</tr>
									</table>
								</td>
							</tr>
							<tr id='tr_loopback' style="display:none;">
								<td> 
									<table width="98%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td class="font5"> Loopback 방지 설정</td>
										</tr>
										<tr>
											<td class="PD4"></td>
										</tr>
													...
													<tr>
														<td width="600">
															<table  border="0" cellpadding="0" cellspacing="0" class="font1">
																<tr>
																	<td width="110">
																		<input type="radio" name="loopback_Enbable" id="loopback_Enable" value="1">
																		활성
																	</td>
																	<td>
																		<input type="radio" name="loopback_Enbable" id="loopback_Disable" value="0">
																		비활성 
																	</td>
																</tr>
															</table>
										...
										<tr>
											<td class="PD6" >	
												<p align="right"><input type="image" src="/images/BTN/BTN_01.gif?Sp2" alt="" width="52" height="24" value="Apply1" id="btn_apply1" name="btn_apply1" onclick="form_act('/goform/mcr_setLoopback'); return false;"/>
											</td>
										</tr>
									</table>
								</td>
