...
var beforeSubMenu2Id = "image2";
var beforeSub21Btn = "image2_24";
...
function changeBtn(clickId, pageUrl){
	...
	if(beforeId != clickId || (beforeId == "image2" && clickId == "image2")) {
		...
		if(clickId != "image1" || clickId != "image2" || clickId != "image3") {
			changePage(pageUrl);
...
function changeWirelessSubMenu1Btn(clickId, pageUrl, redirectURL, wlanIfIndex){
	WirelessSetFormElement(parent.document, "redirect-url", "/new/AdminFolder/"+redirectURL);
	...
	<tr>
		<td width="200" style="font-size:5px;" valign="top">
			...
			<table id="subMenu1" class="td" cellpadding="0" cellspacing="0" width="100%" style="display:inline;">
                		...
                		<tr class="td">
                    			<td width="200" style="font-size:2px;">
                        			<p><a href="javascript:;" Onclick="changeSubMenu1Btn('image14', '1_4_log_info.asp')+blur()" OnMouseOut="changeMouse_1('image14')" OnMouseOver="na_change_img_src('image14', 'document', '/images/2Depth_admin/admin_A-4_mouse.gif?Sp2', true);"><img src="/images/2Depth_admin/admin_A-4_default.gif?Sp2" width="200" height="22" border="0" id="image14" name="image14" style="cursor:hand"></a></p>
                    			</td>
                		</tr>
			</table>
			...
			<table id="subMenu3" class="td" cellpadding="0" cellspacing="0" width="190" style="display:none;">
				<tr>
					<td width="200" style="font-size:2px;">
