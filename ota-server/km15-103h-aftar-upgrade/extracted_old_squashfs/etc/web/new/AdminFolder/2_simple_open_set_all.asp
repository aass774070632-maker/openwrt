...
function initForm_WLAN(flag){
	...
	$("#wlanRedirectPage").val("/new/AdminFolder/2_simple_open_set_all.asp");
	$("#wlanViewWMM").hide();
	$("#wlanViewWMM_5g").hide();
	...
	if ( document.form_simple.macCloneEnbl[0].checked == true)
	{
		if (document.form_simple.macCloneMac.value != "") {
			...
			if (re.test(document.form_simple.macCloneMac.value)) { 
				document.form_simple.redirect_url.value = "/new/AdminFolder/2_simple_open_set_all.asp"
				form_act(url);
...
<input type=hidden name=SETIPMODE value="/new/AdminFolder/2_simple_open_set_all.asp" />
<input type="hidden" name="redirect_url" id="redirect_url" value="/new/AdminFolder/3_7_8_system_restart_process.asp" />
<input type="hidden" name="redirect_admWanSet" id="redirect_admWanSet" value="/new/AdminFolder/2_simple_open_set_all.asp" />
