...
function enable_format(id, wlanEnable) {
	...
	if ( wlanEnable == "0" ) {
		element.innerHTML = "비활성";
	} else if ( wlanEnable == "1" ) {
		element.innerHTML = "활성";
	}
}
function security_format(id, wlanSecurityMode) {
	...
	element.innerHTML = conv2Str_WLAN_SecurityMode(wlanSecurityMode, null);
}
function mode_format(id, wlanMode) {
	...
	if ( wlanMode == "1" ) {
		...
		document.getElementById(id).innerHTML = "11n/ac";
	} else if ( wlanMode == "28" ) {
					...
					<td>
						<table class="TB" width="100%" border="0">
							...
							<tr id="view_2g_ssid_100">
								...
								<td class="BG2-3" name="mode_100" id="mode_100" value=""></td>
							</tr>
