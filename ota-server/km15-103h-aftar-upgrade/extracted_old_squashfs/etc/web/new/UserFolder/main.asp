...
<form name="form">
<table border="0" cellpadding="0" cellspacing="0" style="font-size:10px" width="990" height="500">
	<tr height="55">
		<td colspan="2">
	...
	<tr>
		<td width="202" valign="top" style="font-size:5px;">
			...
			<iframe name="menu" id="menu" src="/new/UserFolder/menu.asp" frameborder="0" width="202" height="100%" scrolling="no" onload="this.style.height=this.contentWindow.document.body.scrollHeight;"></iframe>
			</div>
	    ...
	    <td valign="top" bgcolor="#FFFFFF" style="font-size:5px; padding-top:0;">
			...
			<iframe name="main" id="main" src="/new/UserFolder/1_1_status_info.asp" frameborder="0" width="100%" scrolling="no" onload="this.style.height=this.contentWindow.document.body.scrollHeight;"></iframe>
			</div>
