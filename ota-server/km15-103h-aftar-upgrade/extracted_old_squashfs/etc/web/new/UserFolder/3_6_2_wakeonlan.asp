...
<table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
	...
	<tr style="display:none">
		<td>
			<input name="redirect_url" type="hidden" onmouseover="unlock();" onmouseout="lock();" readonly="readonly" class="input2" id="redirect_url" value="/new/UserFolder/3_6_2_wakeonlan.asp">
		</td>
	</tr>
	<tr>
		<td>
...
<table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
	<table class="TB" width="98%" border="0">
		...
		<tr style="display:none">
			<td>
				<input name="redirect_url" type="hidden" onmouseover="unlock();" onmouseout="lock();" readonly class="input2" id="redirect_url" value="/new/UserFolder/3_6_2_wakeonlan.asp">
			</td>
		</tr>
		<tr>
			<td>
