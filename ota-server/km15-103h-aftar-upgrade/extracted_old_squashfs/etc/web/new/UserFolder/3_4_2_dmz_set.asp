...
<table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
	<tr>
		<td valign="top">
			<%include('new/UserFolder/3_4_menu3rd.asp');%>
			</td>
    </tr>
    <tr>
        <td width="800" style="font-size:5px;" valign="top" bgcolor="#FFFFFF">
			<input type="hidden" name="SETDMZ" value="/new/UserFolder/3_4_2_dmz_set.asp">
					...
					<td valign="top">
						<table width="98%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr id="tr_2" style="display:none">
								<td valign="top">
									<input type="hidden" name="ADDEXTDMZ" value="/new/UserFolder/3_4_2_dmz_set.asp">
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
							...
							<tr id="tr_3" style="display:none">
								<td valign="top">
									<input type="hidden" name="DELEXTDMZ" value="/new/UserFolder/3_4_2_dmz_set.asp">
									<table class="TB" width="100%" border="0">
										<tr>
