...
<form method="post" class="form_layout" id="form_netkeep" name="form_netkeep" action="/goform/mcr_setNetKeepInfo" onsubmit="return validateOnSubmit()">

	
<input type="hidden" id="wlanRedirectPage" name="wlanRedirectPage" value="/new/UserFolder/3_6_5_internet_use_manage.asp">
<input type="hidden" id="ruleList" name="ruleList" value="">
	
<table width="800%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td valign="top">
			<%include('new/UserFolder/3_6_menu3rd.asp');%>
		</td>
	</tr>
	<tr>
												...
												<table border="0" cellpadding="0" cellspacing="0" class="font1">
													...
													<tr>
														...
														<input type="text" id="timeStart_hour" name="timeStart_hour" size="2" maxlength="2" value="">
    														<label> : </label>
    														<input type="text" id="timeStart_min" name="timeStart_min" size="2" maxlength="2" value="">
														<label> ~ </label>
    														<input type="text" id="timeEnd_hour" name="timeEnd_hour" size="2" maxlength="2" value="">
    														<label> : </label>
    														<input type="text" id="timeEnd_min" name="timeEnd_min" size="2" maxlength="2" value="">
														</td>
													</tr>
												</table>
											</td>
