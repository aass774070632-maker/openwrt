					...
					<td valign="top">
						...
						<table width="98%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr style="display:none">
								<td>
									<input name="redirect_url" type="text" onmouseover="unlock();" onmouseout="lock();" readonly class="input2" id="redirect_url" value="/new/UserFolder/3_7_8_system_restart_process.asp">
								<td>
							</tr>
							<tr>
								<td>
