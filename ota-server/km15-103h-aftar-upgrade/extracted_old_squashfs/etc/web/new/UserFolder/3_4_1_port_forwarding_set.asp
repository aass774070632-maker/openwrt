...
<table width="800" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
        <td width="800" style="font-size:5px;" valign="top" bgcolor="#FFFFFF">
			<input type="hidden" name="SETNATFWD" value="/new/UserFolder/3_4_1_port_forwarding_set.asp">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td>
									...
									<input type="hidden" name="DELNATFWD" value="/new/UserFolder/3_4_1_port_forwarding_set.asp">
