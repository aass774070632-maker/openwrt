		...
		<td colspan="2">
			<table width="98%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td class="PD6">
						<p align="right">
							<input type="image" src="/images/BTN/BTN_08.gif?Sp2" width="71" height="24" onclick="clearFlashLog();">
		...
		<td valign="top">
			<table width="98%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td class="PD6">
						<p align="right">
							<input type="image" src="/images/BTN/BTN_08.gif?Sp2" width="71" height="24" onclick="clearMemoryLog();">
