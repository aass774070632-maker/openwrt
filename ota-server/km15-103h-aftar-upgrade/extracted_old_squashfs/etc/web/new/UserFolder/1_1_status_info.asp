					...
					<td valign="top">
						<table class="TB" width="100%" border="0" id="tbl_lan_info">
							...
							<tr id="tr_lan_kornet_ip_range">
								...
								<td class="BG2-2">
									<input name="dhcpStart" type="text" class="input2" id="dhcpStart" value="<% mcr_getCfgInterface("DhcpsCfgParam_StartIp"); %>" disabled> 
									~ 
									<input name="dhcpEnd" type="text" class="input2" id="dhcpEnd" value="<% mcr_getCfgInterface("DhcpsCfgParam_EndIp"); %>" disabled>
								</td>
							</tr>
							<tr id="tr_primium_dhcp_ip_range">
								<td class="BG2" style="width:140px;">프리미엄 DHCP IP 범위</td>
								<td class="BG2-2">
									<input name="dhcpStartSnd" type="text" class="input2" id="dhcpStartSnd" value="<% mcr_getCfgInterface("DhcpsCfgParam_StartIp_Snd"); %>" disabled> 
									~ 
									<input name="dhcpEndSnd" type="text" class="input2" id="dhcpEndSnd" value="<% mcr_getCfgInterface("DhcpsCfgParam_EndIp_Snd"); %>" disabled>
								</td>
							</tr>
