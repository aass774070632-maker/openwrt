...
<input type="hidden" id="Redirect_url" name="Redirect_url" value="/new/UserFolder/3_6_4_nas.asp" />
										...
										<tr id = "dlnaset">
											...
											<td class="BG2-2" width="600">
												<table  border="0" cellpadding="0" cellspacing="0" class="font1">
													<tr>
														<td width="110">
															<input name="nasWebenable" type="radio" value="1"/> 활성
														</td>
														<td>
															<input name="nasWebenable" type="radio" value="0"/> 비활성
														</td>
													</tr>
												</table>
											</td>
