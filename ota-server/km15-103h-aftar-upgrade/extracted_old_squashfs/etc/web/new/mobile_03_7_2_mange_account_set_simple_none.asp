...
function logoff(){
	remove_auth_cache();
	document.User.action = "/goform/mcr_wlan_simple_KTlogOut";
...
<input name="simple_flag" type="hidden" id="simple_flag" value="1">
<input name="redirect_url" type="hidden" id="redirect_url" value="/new/mobile_03_7_2_mange_account_set_simple_none.asp">
	...
	<div style="padding:10px 0 0 0;">
		<table align="center" cellspacing="0" cellpadding="0" width="100%" valign="middle">
			<tr>
				...
				<td>
					<a href="javascript:;" id="btn_apply1" name="btn_apply1" onclick="return form_act('/goform/mcr_wlan_simple_KTlogOut')" data-theme="a" data-role="button" data-mini="false" data-ajax="false">취소</a>
				</td>
			</tr>
		</table>
	</div>
